...
int main(void) {
    ...
    // PRINT SULLA CONSOLE
    // L'indice 0 è influenzato dall'indice 0
    // L'indice 1 è influenzato dall'indice 0
    // L'indice 2 è influenzato dall'indice 0
    // L'indice 3 è influenzato dall'indice 0
 }